...
{
public:
    NoRandomizer(IDataDeserializerPtr deserializer, bool multithreadedGetNextSequences = false, bool useLocalTimeline = false);
...
private:
    ...
    // Useful in case deserializer performs CPU intensive deserialization (i.e. decompression)
